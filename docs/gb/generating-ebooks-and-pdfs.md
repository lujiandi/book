...
<p>`ebook-convert` 可以用来生成电子书（epub，mobi，pdf）。 </p>
<p>win需要安装<a href="https://calibre-ebook.com/download_windows">calibre</a> </p>
...
封面用于所有电子书格式。您可以自己提供一个，也可以使用  [gitbook-plugin-autocover ](https://plugins.gitbook.com/plugin/autocover) 生成一个。
